...
$response->data_add(new ResponseElement("link", "https://www.paypal.com/pl/home"));
$response->data_add(new ResponseElement("offer_id", $offer_id));
$response->data_add(new ResponseElement("duration", $two_weeks));
